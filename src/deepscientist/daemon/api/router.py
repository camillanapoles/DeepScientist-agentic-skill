...
ROUTES: list[tuple[str, re.Pattern[str], str]] = [
    ...
    ("GET", re.compile(r"^/api/orchestration/objects$"), "orchestration_list_objects"),
    ("POST", re.compile(r"^/api/orchestration/objects$"), "orchestration_create_object"),
    ("GET", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)$"), "orchestration_get_object"),
    ("PATCH", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)$"), "orchestration_update_object"),
    ("DELETE", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)$"), "orchestration_delete_object"),
    ("GET", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/events$"), "orchestration_get_events"),
    ("GET", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/decisions$"), "orchestration_get_decisions"),
    ("POST", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/events$"), "orchestration_ingest_event"),
    ("GET", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/playbook$"), "orchestration_render_playbook"),
    ("POST", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/propose$"), "orchestration_propose_action"),
    ("POST", re.compile(r"^/api/orchestration/environment/detect$"), "orchestration_detect_environment"),
    ("GET", re.compile(r"^/api/orchestration/environment/(?P<environment>[^/]+)$"), "orchestration_resolve_environment"),
    ("POST", re.compile(r"^/api/orchestration/merge-gate/run$"), "orchestration_run_merge_gate"),
    ("GET", re.compile(r"^/api/orchestration/objects/(?P<object_id>[^/]+)/verdict$"), "orchestration_verdict"),
